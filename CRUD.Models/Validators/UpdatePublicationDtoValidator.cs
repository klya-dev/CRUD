...
/// </remarks>
public sealed class UpdatePublicationDtoValidator : AbstractValidator<UpdatePublicationDto>
{
    public UpdatePublicationDtoValidator(IValidatorLocalizer localizer)
    {
