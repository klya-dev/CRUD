...
public interface IPublicationManager
{
    ...
    Task<PaginatedListDto<PublicationDto>> GetPublicationsDtoAsync(int pageIndex, int pageSize, string? searchString = null, string sortBy = SortByVariables.date_desc, CancellationToken ct = default);
