        ...
        if (context.Request.Path.StartsWithSegments("/metrics"))
        {
            ...
            if (context.Request.Headers.TryGetValue("Authorization", out var authHeader))
            {
                ...
                if (headerValue.StartsWith("Basic ", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    var encodedCredentials = headerValue["Basic ".Length..].Trim(); // Получаем закодированное содержимое Basic ("username:password")
            ...
            context.Response.Headers.WWWAuthenticate = "Basic realm=\"Metrics API\"";
