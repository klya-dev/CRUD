...
public sealed class CreatePublicationDtoValidatorUnitTest
{
    private readonly CreatePublicationDtoValidator _validator;

    public CreatePublicationDtoValidatorUnitTest()
    {
    ...
    public async Task ValidateAsync_CorrectData_ReturnsIsValid(string title, string content)
    {
        ...
        // Act
        var result = await _validator.ValidateAsync(createPublicationDto, cancellation: TestContext.Current.CancellationToken);
    ...
    public async Task ValidateAsync_NullObject_ThrowsInvalidOperationException()
    {
        ...
        Func<Task> a = async () =>
        {
            await _validator.ValidateAsync(createPublicationDto, TestContext.Current.CancellationToken);
        };
